...
class UIMenuToolbarManagement:
    ...
    def create_menu_bar(self, root):
        ...
        Widget_menu.add_command(label="Freehand Drawing", command=self._open_freehand_drawing, activebackground="lightgray", activeforeground="Lime")
        Widget_menu.add_separator()
        Widget_menu.add_command(label="Calculator", command=self._add_calculator, activebackground="lightgray", activeforeground="Lime")
        Widget_menu.add_separator()
